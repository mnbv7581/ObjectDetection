...
class_names =  ["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", #8
    "boat", "traffic light", "fire hydrant", "stop sign", "parking meter", "bench",#6
    "bird", "cat", "dog", "horse", "sheep", "cow", "elephant", "bear", "zebra", "giraffe",#10
    "backpack", "umbrella", "handbag", "tie", "suitcase", "frisbee", "skis", "snowboard", #8
    "sports ball", "kite", "baseball bat", "baseball glove", "skateboard", "surfboard",#6
    "tennis racket", "bottle", "wine glass", "cup", "fork", "knife", "spoon", "bowl",#8
    "banana","apple", "sandwich", "orange", "broccoli", "carrot", "hot dog", "pizza", "donut",#9
    "cake","chair", "sofa", "pottedplant", "bed", "diningtable", "toilet", "tvmonitor", "laptop",#9
    "mouse","remote", "keyboard", "cell phone", "microwave", "oven", "toaster", "sink",#8
    "refrigerator","book", "clock", "vase", "scissors", "teddy bear", "hair drier", "toothbrush"]#8
